...
namespace DoNet.Code
{
    public static partial class Ext
    {
        ...
        /// </summary>
        /// <param name="data">数据</param>
        public static DateTime? ToEndDate(this object data)
        {
            if (data == null)
            {
                return null;
            ...
            if (isValid)
            {
                return Convert.ToDateTime(result.ToString("yyyy-MM-dd")  + " 23:59:59");
            }
            return null;
        }
        ...
        /// <returns></returns>
        public static object ToType(this object convertibleValue, Type type)
        {
